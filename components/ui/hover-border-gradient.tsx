...
>) {
  ...
  // Memoizing rotateDirection using useCallback
  ...
  }, [clockwise]); // Only re-create the function if clockwise changes

  // Radial gradient directions based on state
  ...
  // useEffect with the added dependency `rotateDirection`
  useEffect(() => {
    if (!hovered) {
  ...
  }, [hovered, duration, rotateDirection]);  // Added `rotateDirection` as a dependency
