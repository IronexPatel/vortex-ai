...
const TermsAndConditions = () => {
    return (
        <motion.div 
            className="max-w-5xl mx-auto p-8 text-gray-800 bg-gray-50 min-h-screen"
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.6 }}
        >
            <motion.h1 
                className="text-4xl sm:text-5xl font-extrabold text-center mb-12 text-purple-500"
                initial={{ opacity: 0, y: -20 }}
                animate={{ opacity: 1, y: 0 }}
            ...
            <section className="mb-12">
                ...
                <ul className="list-disc ml-6 sm:ml-8 mt-4 text-base sm:text-lg leading-relaxed text-gray-800">
            ...
            <section className="mb-12">
                ...
                <p className="mt-4 text-base sm:text-lg leading-relaxed text-gray-800">
                    ...
                    <a href="mailto:support@whiz.com" className="text-purple-500 underline">ironex75@gmail.com</a>.
                </p>
            </section>
        </motion.div>
    );
